...
model Joint_rotational
  annotation (Diagram(coordinateSystem(extent = {{-140.0, -100.0}, {140.0, 100.0}}, preserveAspectRatio = false, grid = {2.0, 2.0})), 
    Icon(coordinateSystem(extent = {{-100.0, -100.0}, {100.0, 100.0}}, 
      ...
      pattern = LinePattern.Dash, 
      thickness = 3.0), Text(origin = {-24.0, -78.0}, 
      extent = {{-52.0, 14.0}, {52.0, -14.0}}, 
      textString = "%name", 
  ...
  Modelica.Mechanics.MultiBody.Joints.Revolute joint(animation = true, useAxisFlange = true) annotation (Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Mechanics.MultiBody.Parts.FixedRotation frameRotation(animation = false, 
