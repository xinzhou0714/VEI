...
model SimpleStructure
  annotation (Diagram(coordinateSystem(extent = {{-200.0, -200.0}, {200.0, 200.0}}, 
    ...
    Icon(coordinateSystem(extent = {{-200.0, -200.0}, {200.0, 200.0}}, 
      preserveAspectRatio = false, 
      grid = {2.0, 2.0}), graphics = {Bitmap(origin = {0.0, 10.0}, 
      extent = {{-180.0, -140.0}, {180.0, 140.0}}, 
      fileName = "modelica://MECS_Simulation/Resources/Images/SimpleStructure.png"), Line(origin = {-30.0, -25.0}, 
      points = {{-140.0, 25.0}, {140.0, -25.0}}, 
      color = {255, 255, 0}, 
      thickness = 3.0, 
  ...
  Modelica.Mechanics.Rotational.Interfaces.Flange_a flange_a
    annotation (Placement(transformation(origin = {-180.0, 0.0}, 
      extent = {{-10.0, -10.0}, {10.0, 10.0}})));
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedTranslation(r = {0, -0.086, 0.128})
  ...
  Modelica.Mechanics.MultiBody.Visualizers.FixedFrame fixedFrame
    annotation (Placement(transformation(origin = {114.0, -46.0}, 
      extent = {{-20.0, -20.0}, {20.0, 20.0}})));
equation 
  connect(flange_a, joint_rotational.flange_a)
    annotation (Line(origin = {-151.0, 0.0}, 
  ...
  connect(fixedTranslation.frame_b, joint_rotational.frame_a)
    annotation (Line(origin = {-39.0, -77.0}, 
      points = {{47.0, -37.0}, {-47.0, -37.0}, {-47.0, 37.0}}, 
      color = {95, 95, 95}, 
      thickness = 0.5));
