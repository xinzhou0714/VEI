...
model IK_solver_planar
  annotation (Diagram(coordinateSystem(extent={{-140.0,-100.0},{140.0,100.0}}, preserveAspectRatio=false, grid={2.0,2.0})), Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=false, grid={2.0,2.0}), graphics={Rectangle(origin={-69.0,-3.0}, fillColor={255,255,255},
            ...
            =                                                                                                                                                                                                        "ß", textStyle={TextStyle.None}),Text(origin={-68.0,-55.0}, extent={{-12.0,11.0},{12.0,-11.0}}, textString
            ...
            lineThickness =                                                                                                                                                                                                        2.0, extent={{-14.0,67.0},{14.0,-67.0}}),Polygon(origin={-1.0,-6.0},
            ...
            lineThickness =                                                                                                                                                                                                        2.0, extent={{-90.0,74.0},{90.0,-74.0}}),Text(origin={1.8303030303030141,84.16969696969696}, extent={{-58.169696969696965,12.169696969696972},{58.169696969696986,-12.169696969696957}}, textString
