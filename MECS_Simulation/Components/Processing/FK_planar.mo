...
equation
  ...
  annotation (Diagram(coordinateSystem(extent={{-140.0,-100.0},{140.0,100.0}}, preserveAspectRatio=false, grid={2.0,2.0})), Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=false, grid={2.0,2.0}), graphics={Rectangle(origin={71.0,-3.0}, fillColor={255,255,255},
            lineThickness =                                                                                                                                                                                                        2.0, extent={{-13.0,67.0},{13.0,-67.0}}),Text(origin={72.0,50.0}, extent={{-12.0,10.0},{12.0,-10.0}}, textString
            ...
            lineThickness =                                                                                                                                                                                                        2.0, extent={{-14.0,67.0},{14.0,-67.0}}),Polygon(origin={7.0,4.0},
            ...
            lineThickness =                                                                                                                                                                                                        2.0, extent={{-90.0,74.0},{90.0,-74.0}}),Text(origin={-2.169696969696986,88.16969696969696}, extent={{-58.169696969696965,12.169696969696972},{58.169696969696986,-12.169696969696957}}, textString
