...
model FDMU_UR10
  ...
  parameter SI.AngularVelocity refSpeedMax[6]={3.1415926535898,3.1415926535898,
      3.1415926535898,2.0943951023932,2.0943951023932,2.0943951023932}                                                                          "Maximum reference speeds of all joints"
  ...
  parameter SI.Time Ts6=0.05 "Time constant of integrator of speed controller"
    annotation (Dialog(tab="Controller", group="Axis 6"));
  Modelica.Mechanics.MultiBody.Examples.Systems.RobotR3.Components.PathPlanning6 pathPlanning6_1(naxis=6, angleBegDeg={startAngle1,startAngle2,startAngle3,startAngle4,startAngle5,startAngle6}, angleEndDeg={endAngle1,endAngle2,endAngle3,endAngle4,endAngle5,endAngle6}, speedMax=refSpeedMax, accMax(displayUnit="deg/s2") = refAccMax, startTime=refStartTime, swingTime=refSwingTime) annotation (Placement(transformation(origin={-64.0,80.0}, extent={{-10.0,-10.0},{10.0,10.0}})));
  ...
  Modelica.Mechanics.MultiBody.Examples.Systems.RobotR3.Components.AxisType2 axis4(kp=kp4, ks=ks4, Ts=Ts4, k=0.2365, w=6250, D=0.55, J=1.6e-4,
    ratio=200,                                                                                                                                            Rv0=21.8, Rv1=9.8, peak=26.7/21.8) annotation (Placement(transformation(origin={-18.0,-6.0}, extent={{-10.0,-10.0},{10.0,10.0}})));
  ...
  Modelica.Mechanics.MultiBody.Examples.Systems.RobotR3.Components.AxisType1 axis2(kp=kp2, ks=ks2, Ts=Ts2, w=5500,
    ratio=200,                                                                                                                Rv0=0.5, c=8, cd=0.01) annotation (Placement(transformation(origin={-18.0,-48.0}, extent={{-10.0,-10.0},{10.0,10.0}})));
  ...
  Modelica.Mechanics.MultiBody.Examples.Systems.RobotR3.Components.AxisType2 axis5(kp=kp5, ks=ks5, Ts=Ts5, k=0.2608, w=6250, D=0.55, J=1.8e-4,
    ratio=200,                                                                                                                                             Rv0=30.1, Rv1=0.03, peak=39.6/30.1) annotation (Placement(transformation(origin={-18.0,16.0}, extent={{-10.0,-10.0},{10.0,10.0}})));
  Modelica.Mechanics.MultiBody.Examples.Systems.RobotR3.Components.AxisType2 axis6(kp=kp6, ks=ks6, Ts=Ts6, k=0.0842, w=7400, D=0.27, J=4.3e-5,
    ratio=200,                                                                                                                                            Rv0=10.9, Rv1=3.92, peak=16.8/10.9) annotation (Placement(transformation(origin={-18.0,42.0}, extent={{-10.0,-10.0},{10.0,10.0}})));
...
equation
  connect(controlBus, pathPlanning6_1.controlBus) annotation (Line(origin={-42.0,34.0}, points={{-28.0,-34.0},{-28.0,30.0},{-12.0,30.0},{-12.0,46.0}}, color={255,204,51}, thickness=0.5));
